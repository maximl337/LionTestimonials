<div class="panel panel-default">
    <div class="panel-heading branding-primary-color">Add Testimonial</div>
    ...
    <div class="panel-body">
        ...
        <form  enctype="multipart/form-data" id="create-testimonial" method="post" action="{{ env('APP_URL') . 'testimonials' }}" role="form" novalidate>
            ...
            <input type="hidden" name="invite_token" value="{{ $data['invitation']->token }}">
        ...
        <div class="form-group">
            <input type="submit" 
                    value="Send Testimonial" 
                    class="form-control btn btn-primary" 
                    style="{{ !empty($primary_color) ? 'background-color: ' . $primary_color : '' }}" />
        </div>
